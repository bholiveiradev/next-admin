	...
	return (
		<>
			<Head>
			    ...
			    <link rel="stylesheet" href="/static/pages/waves/css/waves.min.css" media="all"/>
			    <link rel="stylesheet" href="/static/icon/themify-icons/themify-icons.css"/>
		                            ...
		                            <div className="auth-box card">
		                                <div className="card-block">
		                                    ...
		                                    <div className="form-group form-primary">
		                                        <input type="text" name="email" className="form-control" required="required"/>
			...
			<script type="text/javascript" src="/static/pages/waves/js/waves.min.js"></script>
